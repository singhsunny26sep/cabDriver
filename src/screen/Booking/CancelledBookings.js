...
export default function CancelledBookings({navigation}) {
    ...
    try {
      ...
      if (socketServices.isConnected()) {
        ...
        socketServices.on(`${activeTab}_booking_list`, data => {
          ...
          // Filter data to only show items with "cancelled" status
    ...
    return (
      <View style={styles.emptyContainer}>
        <Text style={styles.emptyText}>
          No {getTypeNameByValue(activeTab)} cancelled bookings available.
        </Text>
      </View>
    );
  };
